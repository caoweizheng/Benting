/**
 * v1.1 180328 [+]ImgView
 * const prefixCls = 'styles-13399813';
 * const images = '/static/images/components/DiscuzContent';
 * @Author: Jack
 * @Date:   2017-12-27 16:36:51
 * @Last Modified by:   Jack
 * @Last Modified time: 2018-03-28 12:10:18
 * @Path btWap \components\DiscuzContent\index.js
 */
'use strict';
...
export default class DiscuzContent extends React.Component {
    ...
    componentDidMount() {
        ...
        if (imgView) {
            document
                .querySelector(`.${prefixCls}-imgview`)
    ...
    fixedRichHtml = html => {
        ...
        //去掉Discuz的引用回复样式
        return (html = html
            //(1): <div class="quote"><blockquote><font size="2">[url=forum.php?mod=redirect&goto=findpost&pid=1966029&ptid=47643]<font color="#999999">张锦坤 发表于 2017-6-6 13:55</font>[/url]</font>人家说的是弩火天尊福利竿，我的可是真金白银买的</blockquote></div>快来人啊，有人转卖福利了{:7_347:}
            //(2): <div class="quote"><blockquote><font color="#999999">恋鱼 发表于 2017-6-6 13:44</font><font color="#999999">看楼上的说法 楼主可要小心啊</font></blockquote></div>人家说的是弩火天尊福利竿，我的可是真金白银买的
            .replace(/\[url([\s\S]*)\d\]/g, '')
            .replace('[/url]', '')
            //给图片加上域名
            //(1): <font size="5"><font color="darkred">一小片自留地，今年中的小西红柿，结了不少，晒晒！</font></font><font size="5"><div class="attach"><img src="201706/06/095308gtt4ax0hmhuta100.jpg" /></div><div class="attach"><img src="201706/06/095309pidecjxx80yayy95.jpg" /></div><div class="attach"><img src="201706/06/095310x8i03xccn50d4ma5.jpg" /></div><div class="attach"><img src="201706/06/095311dscqcis7o8vrgsvq.jpg" /></div></font>
            .replace(
                /<img src="/g,
            ...
            .replace(/\{\:([\d_]+)\:\}/g, match => {
                ...
                if (
                    filename.indexOf('4_') !== -1 ||
                    filename.indexOf('5_') !== -1
                ) {
                    emojiType = 't-qq';
                } else {
                    emojiType = 't-emoji-bbs';
                }

                return `<img class="${emojiType}" src="${Const.__EMOJI_PATH__}/${filename}.gif" />`;
            })
            //emoji
            .replace(/\[([^[])+\]/g, match => {
                const filename = match.replace('[', '').replace(']', '');

                return `<img class="tool-qq" src="${Const.__EMOJI_PATH__}/${filename}.png" />`;
            })
            //换行
            .replace(/\n/g, '<br />'));
    };
